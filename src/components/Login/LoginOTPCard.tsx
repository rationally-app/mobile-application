...
export const LoginOTPCard: FunctionComponent<LoginOTPCard> = ({
  ...
  return (
    <Card>
      <AppText>{`${getTranslatedStringWithI18n(
        "loginOTPCard",
        "sendingOtp"
      )}...`}</AppText>
      <View style={styles.inputAndButtonWrapper}>
        <InputWithLabel
          label={getTranslatedStringWithI18n("loginOTPCard", "otp")}
          value={oTPValue}
        ...
        <View style={styles.buttonsWrapper}>
          {resendDisabledTime > 0 ? (
            ...
            <SecondaryButton
              text={getTranslatedStringWithI18n("loginOTPCard", "resend")}
              onPress={resendOTP}
          ...
          <View style={styles.submitWrapper}>
            <DarkButton
              text={getTranslatedStringWithI18n("loginOTPCard", "submit")}
              fullWidth={true}
              onPress={onSubmitOTP}
              isLoading={isLoading}
