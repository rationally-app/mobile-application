...
const secondaryButtonElements: JSX.Element[] = [
  ...
  <SecondaryButton
    ...
    text="Icon Button"
    icon={
      <Feather name="shopping-cart" size={size(2)} color={color("grey", 100)} />
    }
  />,
  <SecondaryButton key="6" text="FullWidth Button" fullWidth={true} />,
];

storiesOf("Layout/Button", module)
  .add("Button", () => (
  ...
  .add("TransparentButton", () => (
    <View style={styles.wrapper}>
      <View style={styles.item}>
        <AppText>
          The TransparentButton&apos;s text is white and is visible on a dark
          background
        </AppText>
      </View>
      <View
